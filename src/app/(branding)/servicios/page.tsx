    ...
    return(
      ...
      <div className='container mx-auto'>
        <div className='grid md:grid-cols-2 gap-10 my-5'>
          <div className='bg-cover bg-center p-24 rounded-md mx-5' style={{ backgroundImage: `url('/images/backgrounds/building-background.jpg')`, }}>
          </div>
          <div className='flex flex-col justify-center md:py-24 px-5 md:px-0'>
            ...
            <div className='flex flex-col sm:flex-row mt-5 gap-5'>
              ...
              <Link href='/contacto' className='bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md'>Contactar</Link>
              </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-16 lg:gap-5 mt-28 container mx-auto'>
          <div className='shadow-xl p-4 rounded-tl-[100px] rounded-b-md rounded-tr-md relative bg-white'>
            <div className='bg-gradient-to-bl from-light-blue-400 via-blue-500 to-blue-700 rounded-xl absolute left-[50%] -translate-x-[50%] -top-10 rotate-45 shadow-md shadow-gray-400'>
              <Image alt='paginas web' className='-rotate-45 brightness-0 invert' src="/images/icons/web-pages.png" width={100} height={100} />
            </div>
          ...
          <div className='shadow-xl p-4 rounded-tl-[100px] rounded-b-md rounded-tr-md relative bg-white'>
            <div className='bg-gradient-to-bl from-light-blue-400 via-blue-500 to-blue-700 rounded-xl absolute left-[50%] -translate-x-[50%] -top-10 rotate-45 shadow-md shadow-gray-400'>
              <Image alt='paginas web' className='-rotate-45 brightness-0 invert' src="/images/icons/project-management.png" width={100} height={100} />
            </div>
          ...
          <div className='shadow-xl p-4 rounded-tl-[100px] rounded-b-md rounded-tr-md relative bg-white'>
            <div className='bg-gradient-to-bl from-light-blue-400 via-blue-500 to-blue-700 rounded-xl absolute left-[50%] -translate-x-[50%] -top-10 rotate-45 shadow-md shadow-gray-400'>
              <Image alt='paginas web' className='-rotate-45 brightness-0 invert' src="/images/icons/cabling.png" width={100} height={100} />
            </div>
          ...
          <div className='shadow-xl p-4 rounded-tl-[100px] rounded-b-md rounded-tr-md relative bg-white'>
            <div className='bg-gradient-to-bl from-light-blue-400 via-blue-500 to-blue-700 rounded-xl absolute left-[50%] -translate-x-[50%] -top-10 rotate-45 shadow-md shadow-gray-400'>
              <Image alt='paginas web' className='-rotate-45 brightness-0 invert' src="/images/icons/voip.png" width={100} height={100} />
            </div>
          ...
          <div className='shadow-xl p-4 rounded-tl-[100px] rounded-b-md rounded-tr-md relative bg-white'>
            <div className='bg-gradient-to-bl from-light-blue-400 via-blue-500 to-blue-700 rounded-xl absolute left-[50%] -translate-x-[50%] -top-10 rotate-45 shadow-md shadow-gray-400'>
              <Image alt='paginas web' className='-rotate-45 brightness-0 invert' src="/images/icons/certificate.png" width={100} height={100} />
            </div>
        ...
        <div className='container relative mx-auto'>
          <div className='grid md:grid-cols-2 mt-10 items-start justify-start'>
            <div className='px-4 md:px-0'>
              ...
              <div className='flex p-4'>
                <div>
                  <Image src='/images/corporate/Hikvision_logo_smart_business.png' width={200} height={100} alt='hikvision' />
                </div>
              </div>
            </div>
            <div className='flex items-center justify-center md:justify-end'>
              <Image className='rounded-md shadow-sm' src='/images/corporate/cctv-room.jpg' width={600} height={400} alt='cuerto cctv' />
            </div>
          </div>
            ...
            <div className='grid  container px-4 md:px-0'>
              <div className=''>
                ...
                <div className='flex gap-5 items-center pt-4'>
                  <div>
                    <Image src='/images/corporate/unifi-icon-smart-business.png' width={40} height={40} alt='ubiquiti log' />
                  </div>
                  <div>
                    <Image src='/images/corporate/mikrotik-logo.png' width={200} height={100} alt='mikrotik logo' />
                  </div>
                  
                  <div>
                    <Image src='/images/corporate/belden_logo.png' width={120} height={40} alt='belden logo' />
                  </div>
                  <div>
                    <Image src='/images/corporate/legrand-logo.png' width={150} height={40} alt='legrand logo' />
                  </div>
                  <div>
                    <Image src='/images/corporate/tp-link.png' width={100} height={40} alt='tp-link logo' />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='container mt-24 mx-auto p-5'>
            ...
            <h4 className='font-semibold text-2xl text-gray-500 text-center'>Sistemas de Energía Ininterrumpida</h4>
              ...
              <div className='flex items-center justify-center md:justify-end'>
                <Image className='rounded-md shadow-sm' src='/images/backgrounds/apc-background.jpg' width={600} height={400} alt='cuerto cctv' />
              </div>
            </div>
          </div>
        </div>
