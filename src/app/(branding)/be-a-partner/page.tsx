...
const BeAPartner: React.FC = () => (
    <div className="container mx-auto max-w-screen-2xl my-5">
            ...
            <div className="container border border-gray-400  mt-5 p-10 rounded-md">
                <div className="grid grid-cols-2 gap-10">
                    <div className="flex flex-col justify-center">
                        <h2 className="text-gray-700 text-3xl font-bold text-center">Cansado de esperar a tu agente de ventas por una simple cotizacion?</h2>
                        <p className="text-center">Registrese como integrador oficial y realice sus propios presupuestos</p>
        ...
        <div className='grid mt-10 grid-cols-2 gap-4'>
            <div className=''>
                <Image height={500} width={600} alt='tecnico CCTV' className="rounded-md " src='/assets/images/backgrounds/hombre-senalando.png' />
            </div>
            <div className='flex items-center flex-col justify-center'>
