...
export const metadata: Metadata = {
  ...
  description: 'Contáctanos para soluciones en CCTV, cableado estructurado y equipos de oficina. Estamos disponibles de lunes a sábado para atenderte. Llámanos al +504 8818-7765.',
  keywords: 'contacto, Smart Business Honduras, CCTV, cableado estructurado, equipos de oficina, Honduras, Tegucigalpa, soporte técnico, atención al cliente',
  openGraph: {
    title: 'Contacto | Smart Business Honduras',
    ...
    url: 'https://smartbusiness.site/contacto',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Smart Business Honduras - Contacto',
      },
    ],
    locale: 'es_HN',
    type: 'website',
  ...
  alternates: {
    canonical: 'https://smartbusiness.site/contacto',
  },
};
          ...
          <div className='col-span-1 mx-4 sm:mx-0 rounded-l-md bg-cover px-5 md:px-10 bg-gray-100'>
            ...
            <div className='grid grid-cols-5 mb-4 rounded-md bg-white border-2 p-5 gap-5'>
              <div className='col-span-2 sm:col-span-1 flex justify-center p-1 md:p-4 bg-[#061E36] rounded-md'>
                <Image className='text-white brightness-0 invert' src="/images/icons/cctv-icon.svg" alt="Phone Icon" width={70} height={70}/>
              </div>
            ...
            <div className='grid grid-cols-5 mb-4 rounded-md bg-white border-2 p-5 gap-5'>
              <div className='col-span-2 sm:col-span-1 flex justify-center p-1 md:p-4 bg-[#061E36] rounded-md'>
                <Image className='text-white brightness-0 invert' src="/images/icons/cabling.png" alt="Phone Icon" width={90} height={90}/>
              </div>
              <div className='col-span-3 sm:col-span-4 relative'>
            ...
            <div className='grid grid-cols-5 mb-4 rounded-md bg-white border-2 p-5 gap-5'>
              <div className='col-span-2 sm:col-span-1 flex justify-center p-1 md:p-4 bg-[#061E36] rounded-md'>
                <Image className='text-white brightness-0 invert' src="/images/icons/servers.png" alt="Phone Icon" width={90} height={90}/>
              </div>
              <div className='col-span-3 sm:col-span-4 relative'>
                  ...
                  <form className='pb-10' >
                    <div className='grid gap-5 grid-cols-2'>
                      ...
                      <div className='col-span-2'>
                        <label className='font-medium text-gray-200'>Mensaje</label>
