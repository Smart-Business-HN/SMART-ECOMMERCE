...
export default function Contact() {
    ...
    <div className='w-full'>
      <div className='bg-center bg-cover mb-5 bg-blue-900 bg-opacity-25 py-36' style={{ backgroundImage: `url('images/backgrounds/map_contact.png')`, }}>
        <div className='container mx-auto flex items-center px-10 sm:px-0'>
          <h1 className='text-4xl mx-auto font-bold text-gray-700 text-left container' id="contacto-titulo">Háblanos de tu nuevo proyecto</h1>
          <div className='text-blue-500 rotate-90 hidden md:block'>
            <svg width="272" height="187" viewBox="0 0 272 187" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 mb-5 shadow-md rounded-md' aria-labelledby="contacto-titulo">
          <div className='col-span-1 mx-4 sm:mx-0 rounded-l-md bg-cover px-5 md:px-10 bg-gray-100'>
            ...
            <div className='grid grid-cols-5 mb-4 rounded-md bg-white border-2 p-5 gap-5'>
              <div className='col-span-2 sm:col-span-1 flex justify-center p-1 md:p-4 bg-[#061E36] rounded-md'>
                <Image className='text-white brightness-0 invert' src="/images/icons/cctv-icon.svg" alt="Icono de sistemas CCTV y videovigilancia" width={70} height={70}/>
              </div>
            ...
            <div className='grid grid-cols-5 mb-4 rounded-md bg-white border-2 p-5 gap-5'>
              <div className='col-span-2 sm:col-span-1 flex justify-center p-1 md:p-4 bg-[#061E36] rounded-md'>
                <Image className='text-white brightness-0 invert' src="/images/icons/cabling.png" alt="Icono de cableado estructurado y redes" width={90} height={90}/>
              </div>
              <div className='col-span-3 sm:col-span-4 relative'>
            ...
            <div className='grid grid-cols-5 mb-4 rounded-md bg-white border-2 p-5 gap-5'>
              <div className='col-span-2 sm:col-span-1 flex justify-center p-1 md:p-4 bg-[#061E36] rounded-md'>
                <Image className='text-white brightness-0 invert' src="/images/icons/servers.png" alt="Icono de equipos de oficina y servidores" width={90} height={90}/>
              </div>
              <div className='col-span-3 sm:col-span-4 relative'>
          ...
          <div className='col-span-1 bg-cover relative rounded-r-md' style={{ backgroundImage: `url('/images/backgrounds/computadora-dell-y-plano.jpg')`, }}>
            <div className='md:rounded-r-md rounded-bl-md  bg-blue-900 bg-opacity-80 left-0 right-0 top-0 bottom-0'>
              <div className='px-5 sm:px-10'>
                <div className='h-full flex flex-col justify-center'>
                  ...
                  <form className='pb-10' aria-labelledby="formulario-contacto">
                    <div className='grid gap-5 grid-cols-2'>
                      <div className='col-span-2 md:col-span-1'>
                        <label className='font-medium text-gray-200' htmlFor="nombre">Nombre</label>
                        <input 
                          type='text' 
                          id="nombre"
                          name="nombre"
                          className="w-full border bg-gray-500 border-none bg-opacity-50 focus:bg-opacity-75 p-2 rounded-md"
                          aria-label="Campo para ingresar nombre"
                          required
                        />
                      </div>
                      <div className='col-span-2 md:col-span-1'>
                        <label className='font-medium text-gray-200' htmlFor="apellido">Apellido</label>
                        <input 
                          type='text' 
                          id="apellido"
                          name="apellido"
                          className="w-full border bg-gray-500 border-none bg-opacity-50 focus:bg-opacity-75 p-2 rounded-md"
                          aria-label="Campo para ingresar apellido"
                          required
                        />
                      </div>
                      <div className='col-span-2 md:col-span-1'>
                        <label className='font-medium text-gray-200' htmlFor="email">Correo Electrónico</label>
                        <input 
                          type='email' 
                          id="email"
                          name="email"
                      ...
                      <div className='col-span-2 md:col-span-1'>
                        <label className='font-medium text-gray-200' htmlFor="asunto">Asunto</label>
                        <input 
                          type='text' 
                          id="asunto"
                          name="asunto"
                          className="w-full border bg-gray-500 border-none bg-opacity-50 focus:bg-opacity-75 p-2 rounded-md"
                          aria-label="Campo para ingresar asunto del mensaje"
                          required
                        />
                      </div>
                      <div className='col-span-2'>
                        <label className='font-medium text-gray-200' htmlFor="mensaje">Mensaje</label>
                        <textarea 
                          id="mensaje"
                          name="mensaje"
                          className="w-full resize-none h-36 border bg-gray-500 border-none bg-opacity-50 focus:bg-opacity-75 p-2 rounded-md"
                          aria-label="Campo para ingresar mensaje"
                          required
                        />
                      </div>
                    </div>
                    <div className='flex mt-5 justify-center'>
                      <button 
                        type="submit"
                        className='bg-blue-500 px-10 py-4 text-white font-medium rounded-md hover:shadow-md'
            ...
            <div className='col-span-1 px-5 sm:px-10'>
              ...
              <div className="rounded border bg-white mt-4 border-gray-200 items-center shadow-md hover:shadow-blue-200 hover:scale-105 transition-all">
                <Link 
                  ...
                  aria-label="Llamar al +504 8818-7765 para consultas"
                >
              ...
              <div className="rounded border bg-white mt-4 border-gray-200 items-center shadow-md hover:shadow-blue-200 hover:scale-105 transition-all">
                <Link 
                  ...
                  aria-label="Contactar por WhatsApp al +504 8818-7765"
                >
                  <div className="col-span-1 ml-4 flex justify-center items-center relative">
                    <div className="absolute -ml-3 mt-1   h-[50px] w-[50px] rounded-lg bg-blue-600"></div>
                    <div className="z-40  h-[50px] flex items-center justify-center w-[50px] p-2 text-white bg-slate-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20">
              ...
              <div className="rounded border bg-white mt-4 border-gray-200 items-center shadow-md hover:shadow-blue-200 hover:scale-105 transition-all">
                <Link 
                  ...
                  aria-label="Seguir SMART Business en Facebook"
                >
                  <div className="col-span-1 ml-4 flex justify-center items-center relative">
                    <div className="absolute -ml-3 mt-1   h-[50px] w-[50px] rounded-lg bg-blue-600"></div>
                    <div className="z-40  h-[50px] flex items-center justify-center w-[50px] p-2 text-white bg-slate-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20">
              ...
              <div className="rounded border mt-4 bg-white border-gray-200 items-center shadow-md hover:shadow-blue-200 hover:scale-105 transition-all">
                <Link 
                  ...
                  aria-label="Seguir SMART Business en Instagram"
                >
                  <div className="col-span-1 ml-4 flex justify-center items-center relative">
                    <div className="absolute -ml-3 mt-1   h-[50px] w-[50px] rounded-lg bg-blue-600"></div>
                    <div className="z-40  h-[50px] flex items-center justify-center w-[50px] p-2 text-white bg-slate-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20">
