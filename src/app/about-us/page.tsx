    ...
    <div className='container mx-auto max-w-7xl my-5'>
        <div className='grid grid-cols-2 gap-4'>
            ...
            <div className='flex items-center flex-col justify-center'>
                ...
                <p className='px-5 mt-2 text-gray-500 text-[14px] font-semibold'>
        ...
        <div className='flex justify-center gap-4 mt-10'>
            <div className='hover:shadow-md border bg-gradient-to-br from-blue-600 via-sky-600 to-sky-400 rounded-md p-[2px] max-w-md'>
                ...
                <div className=''>
                    ...
                    <div className='flex gap-10 mt-5'>
                        <div className='container mt-5 relative'>
                            ...
                            <div className='absolute left-10 p-2 top-10  text-center  bg-gray-600 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 flex gap-2'>
                                <p className='text-white text-xl font-bold'>Productos WISP</p>
                            </div>
                            <div className='absolute right-10 p-2 bottom-10 left-10 text-center  bg-gray-600 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 flex gap-2'>
                                <p className='text-white'>Contamos con todos los productos que necesitas para montar tu propia empresa WISP</p>
                            </div>
                        </div>
                        <div className='container mt-5 relative'>
                            <video className='w-full rounded-xl' autoPlay muted loop>
                            ...
                            <div className='absolute right-10 text-center left-10 p-2 bottom-10  bg-gray-600 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 flex gap-2'>
                            <p className='text-white'>Te brindamos todo lo necesario para escalar tu red corporativa al siguiente nivel</p>
                            </div>
                        </div>
                    </div>
                    <div className='rounded-md bg-gray-100 p-10 mt-10'>
                        <div className='w-full grid grid-cols-2 gap-5'>
                            <div className='flex flex-col justify-center'>
                                ...
                                <p className='text-gray-500 mt-5 font-semibold text-center'>
