...
import NewsletterForm from '@/components/shared/newsletter-form.component';
...
const Footer = () => {
    ...
    return (
        <div className="border-t py-5  shadow-sm shadow-gray-400 w-full gap-4 justify-between bg-[#F6F6F8]">
            <div className='container py-4 max-w-7xl 2xl:max-w-screen-7xl mx-auto'>
                <div className='grid grid-cols-12'>
                    <div className='col-span-12 md:col-span-3 items-center justify-center md:items-start flex-col flex'>
                        <Image src='/images/corporate/logo-smart-business.png' width={250} height={100} alt='Smart Business Logo' />
                    </div>
                ...
                <div className='border-t-2 mt-5 md:mx-10 lg:mx-0 pt-2 md:flex justify-between'>
                    ...
                    <div className='flex md:flex-row-reverse justify-center gap-4 my-4 md:my-0'>
                        <div>
                            <a href={socialMedia.facebook} aria-label="Facebook de Smart Business" target="_blank" rel="noopener noreferrer">
                        ...
                        <div>
                            <a href={socialMedia.instagram} aria-label="Instagram de Smart Business" target="_blank" rel="noopener noreferrer">
