  ...
  return (
    <>
      ...
      <Dialog open={open} handler={onClose} size="md">
        {/* @ts-expect-error Material Tailwind DialogHeader type definitions are overly strict; props are correct per docs */}
        ...
        {/* @ts-expect-error Material Tailwind DialogBody type definitions are overly strict; props are correct per docs */}
        <DialogBody className="max-h-[60vh] overflow-y-auto space-y-3">
          {carts.map((cart) => (
            // @ts-expect-error Material Tailwind Card type definitions are overly strict; props are correct per docs
            <Card
              key={cart.id}
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  >
                    {/* @ts-expect-error Material Tailwind Spinner type definitions are overly strict; props are correct per docs */}
        ...
        {/* @ts-expect-error Material Tailwind DialogFooter type definitions are overly strict; props are correct per docs */}
        <DialogFooter>
          {/* @ts-expect-error Material Tailwind Button type definitions are overly strict; props are correct per docs */}
