...
export default function Branding() {
    ...
    <div className="container w-full rounded-md px-2 md:px-0 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 bg-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border p-5 rounded-l-md items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border p-5 items-center">
                <div className="col-span-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border p-5 rounded-r-md items-center">
                <div className="col-span-1">
