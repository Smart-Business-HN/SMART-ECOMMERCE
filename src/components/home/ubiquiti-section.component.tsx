...
export default function UbiquitiSectionComponent() {
    return (
        <>
            ...
            <div className='w-full mx-auto container mb-5 mt-10 px-4 md:px-0'>
                ...
                <div className='flex flex-col md:flex-row gap-5 justify-between'>
                    <div className='grow animate-fade-right animate-ease-in bg-[#F9F9F9] p-7 rounded-md shadow-sm transition-all hover:shadow-lg'>
                        ...
                        <Link className='flex gap-2 items-center mb-5 text-blue-600 hover:text-blue-500' href='/tienda/conectividad/wifi-empresarial/unifi-u6-pro'>
                        ...
                        <div className='flex mt-15 justify-center'>
                            <Image src="/images/products/U6-Pro-smart-business.png" width={270} height={270} alt="unifi icon" />
                        </div>
                    </div>
                    <div className='grow bg-[#F9F9F9] p-7 animate-fade-right animate-ease-in rounded-md mt-4 md:mt-0 shadow-sm transition-all hover:shadow-lg'>
                        ...
                        <Link className='flex gap-2 items-center mb-5 text-blue-600 hover:text-blue-500' href='/tienda/conectividad/wifi-empresarial/ap-wifi6-de-malla-empresarial-ubiquiti'>
                            <p className=' font-semibold'>Comprar</p>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                            </svg>
                        ...
                        <div className='flex mt-15 justify-center'>
                            <Image src="/images/products/U6-Mesh-smart-business.png" width={270} height={270} alt="unifi icon" />
                        </div>
                    </div>
                    <div className='grow bg-[#F9F9F9] p-7 animate-fade-right animate-ease-in rounded-md mt-4 md:mt-0 shadow-sm transition-all hover:shadow-lg'>
                        ...
                        <Link className='flex gap-2 items-center mb-5 text-blue-600 hover:text-blue-500' href='/tienda/conectividad/wifi-empresarial/ap-unifi-dual-band-180-mimo-2x2-ubiquiti'>
                            <p className=' font-semibold'>Comprar</p>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                            </svg>
                        ...
                        <div className='flex mt-15 justify-center'>
                            <Image src="/images/products/U6-IW-smart-business.png" width={270} height={270} alt="unifi icon" />
                        </div>
                    </div>
                </div>
                <div className='flex flex-col md:flex-row mt-5 items-center rounded-md bg-[#F9F9F9] p-5 animate-fade-up'>
                    <div className='grow'>
                        <Image className='rounded-md' src='/images/products/project-ubiquiti.png' width={600} height={600} alt='Proyectos cableado' />
                    </div>
                    <div className='mt-4 md:mt-0 md:p-14 order-1 grow flex-col justify-center items-center'>
                        ...
                        <Button
                            variant="filled" size="sm" color="blue"
                        >
                            <Link href='/contacto' className=''>Contactar</Link>
                        </Button>
                        </div>
                    </div>
                </div>
